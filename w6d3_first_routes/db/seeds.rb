...
#Artwork
artwork1 = Artwork.create!(title: "Starry Night", artist_id: ryan.id)
artwork2 = Artwork.create!(title: "Impression 4", artist_id: charlos.id)
artwork3 = Artwork.create!(title: "Mona Lisa", artist_id: lina.id)
artwork4 = Artwork.create!(title: "Michael Jackson and Bubbles", artist_id: erik.id)
artwork5 = Artwork.create!(title: "Creation of Adam", artist_id: zack.id)
#ArtworkShare
